          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 col-md-12">
              ...
              >
                ...
                Since starting out in 2011, Global Docs Solution has been d
                edicated to providing reliable and knowledgeable support for 
                all your documentation needs. With over a decade of experience, 
                we aim to make the process smooth and clear for each customer,
                 no matter what. We’re proud to offer quick, dependable help for 
                 personal and business do
                </p>
                <ul className="about-list">
                  ...
                  <li>
                    <i className="ri-check-fill"></i> With over 12 years of experience, we know how to get things done quickly, safely, and reliably—no matter where you are in the world.
                  </li>
                </ul>
