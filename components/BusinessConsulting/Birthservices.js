     ...
     <div className="case-studies-area ptb-100">
      <div className="container">
         <div className="paragraph">
            <h1> Birth Certificate-Attestation</h1> 
          </div>
         <h2>
         <div className="paragraph">
           What is a Birth Attestation services     
         </div>
         </h2>
         <p>
           ...
           <div className="">
              <div className="row mb-40">
               <div className="col-lg-7 col-md-12"> 
                  ...
                  <b>Legal & Medical Purposes –</b> Used in inheritance claims, passport applications, and medical benefits.
                    ...
                    <h3>
                      <div className="paragraph">
                        ...
                        <ol>
                  <li>
                  <b>Notary Attestation – </b> Initial verification by a Notary Public.
                  </li>
                  <li>
                    <b>State Home Department Authentication –</b>Approval from the respective state authority.
                  </li>
                  <li>
                  <b>MEA Attestation –</b> Ministry of External Affairs (MEA) attestation for official verification.
                  </li>
                  <li>
                  <b>
                  Embassy Attestation (If Required) – 
                  </b>Required for non-Hague Convention countries.
                  </li>
                  <li>
                  <b>MOFA Attestation (For Gulf Countries) –</b>Final attestation in the destination country.
                  </li>
                ...
                <i className="ri-checkbox-circle-fill2"></i>&nbsp;&nbsp;
                Copy of Visa (If applicable).<br/>
                <i className="ri-checkbox-circle-fill2"></i>&nbsp;&nbsp;
                National ID Proof (Aadhaar, PAN, etc.).<br/>
                <i className="ri-checkbox-circle-fill2"></i>&nbsp;&nbsp;
                Application Form (As per authority requirement)            
                   ...
                   <p>
                <b>Processing Time:</b> 5-15 working days (varies by country & document type).
                </p> 
                   <h3>
                     <div className="paragraph">
