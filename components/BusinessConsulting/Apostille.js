                  ...
                  <b>Legal Matters  – </b>  Used in property transactions, inheritance claims, and other legal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;procedures.       
                    <div className="container">
                          <div className="center">
                            <div className="paragraph">
                                  <h3>Types of Documents That Require Apostille Services</h3>
                                  </div>
                                </div>
                    ...
                    <h3>
                      ...
                      <ol>
                  <li>
                  <b>Local/State-Level Attestation – </b> Documents are first verified by 
                  HRD, Home Department, or Chamber of Commerce.
                  </li>
                  <li>
                  <b>MEA Apostille Attestation – </b> The Ministry of External Affairs (MEA) issues the apostille stamp.
                  </li>
                  <li>
                  <b>
                  Submission to the Foreign Authority – 
                  </b>Once apostilled, the document becomes legally valid 
